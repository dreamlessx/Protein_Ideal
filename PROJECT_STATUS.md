...
- **Total complexes in BM5.5**: 257 (246 active, 11 excluded)
- **FASTA sequences obtained**: 246/246 (11 OOM targets excluded)
- **Boltz input prepared**: 246/246
...
- **Active benchmark**: **246 targets** (11 excluded — Boltz OOM on large symmetric complexes)
  - 9 full OOM (>3000 total residues, 0/5 models): 1DE4, 1K5D, 1N2C, 1WDW, 1ZM4, 3BIW, 3L89, 4GXU, 6EY6
  - 2 partial OOM (2200-3000 residues, 1/5 models): 1GXD, 3EO1
- **AlphaFold**: **246/246 complete (100%)** — 5 ranked + 5 unrelaxed per target
- **Boltz-1**: **246/246 complete (100%)** — 5 models per target
